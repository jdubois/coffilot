...
const siteBase = normalizeBase(process.env.VUEPRESS_BASE || (process.argv.includes("dev") ? "/" : "/coffilot/"));
const publicSiteUrl = "https://www.julien-dubois.com/coffilot";
const siteDescription =
  "A GitHub Copilot canvas extension that turns a Maven/Gradle Java, Spring Boot or Quarkus project into an interactive console in the Copilot app's side panel.";
...
export default defineUserConfig({
  ...
  head: [
    ...
    ["meta", { property: "og:title", content: "Coffilot" }],
    ["meta", { property: "og:description", content: siteDescription }],
  ],
  bundler: viteBundler(),
  plugins: [cleanDocsPermalinksPlugin(), cleanMarkdownDocLinksPlugin(), lazyLoadMarkdownImagesPlugin()],
  theme: defaultTheme({
    ...
    repo: "jdubois/coffilot",
    docsRepo: "https://github.com/jdubois/coffilot",
    docsBranch: "main",
    docsDir: "docs",
    editLink: true,
    lastUpdated: true,
    ...
    logo: null,
    navbar: [
      { text: "Get started", link: toDocLink("GETTING-STARTED.md") },
...
function cleanDocsPermalinksPlugin() {
  return {
    name: "coffilot-clean-docs-permalinks",
...
function lazyLoadMarkdownImagesPlugin() {
  return {
    name: "coffilot-lazy-load-markdown-images",
...
function cleanMarkdownDocLinksPlugin() {
  return {
    name: "coffilot-clean-markdown-doc-links",
